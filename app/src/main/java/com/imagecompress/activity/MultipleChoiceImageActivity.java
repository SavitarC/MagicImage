...
import com.imagecompress.adapter.PictureAdapter;
import com.imagecompress.bean.api.Contast;
        ...
        ActivityCompat.setExitSharedElementCallback(this, new androidx.core.app.SharedElementCallback() {
            ...
            public void onMapSharedElements(List<String> names, Map<String, View> sharedElements) {
                ...
                switch (mPreviewStatus) {
                    case 0:
                        sharedElements.put(PairHelp.transitionName(), Objects.requireNonNull(mRlOriginal.findViewHolderForAdapterPosition(PairHelp.PREVIEW_POSITION)).itemView);
                        break;
                    case 1:
                        sharedElements.put(PairHelp.transitionName(), Objects.requireNonNull(mRlCompress.findViewHolderForAdapterPosition(PairHelp.PREVIEW_POSITION)).itemView);
                        break;
                }
